...
public class PrintUtil {
    ...
    static void format(ElectricCar car) {
        String[] out = new String[]{
                car.getBrand(),
                car.getType(),
                car.getPower()==0 ? null : String.valueOf(car.getPower()),
                car.getTorque()==0 ? null : String.valueOf(car.getTorque()),
                car.getGears()==0 ? null : String.valueOf(car.getGears()),
                car.getColor(),
                String.valueOf(car.getBatteryCapacity())
        };
        System.out.format(PrintUtil.DATA_OUT_1, out);
        System.out.println(PrintUtil.SEPARATOR_OUT);
    }

    static void format(ElectricCarBuilder car) {
        String[] out = new String[]{
                car.getCar().getBrand(),
                car.getCar().getType(),
                car.getCar().getPower()==0 ? null : String.valueOf(car.getCar().getPower()),
                car.getCar().getTorque()==0 ? null : String.valueOf(car.getCar().getTorque()),
                car.getCar().getGears()==0 ? null : String.valueOf(car.getCar().getGears()),
                car.getCar().getColor(),
                String.valueOf(car.getBatteryCapacity())
        };
        System.out.format(PrintUtil.DATA_OUT_1, out);
