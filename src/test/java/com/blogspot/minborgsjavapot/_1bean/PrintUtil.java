...
public class PrintUtil {
    ...
    private static final String SEPARATOR_OUT = "+----------------------+----------------------+----------------------+----------------------+----------------------+----------------------+",
            HEAD_OUT = "| " + ANSI_FONT_BOLD_ON + "%1$-20s" + ANSI_RESET + " | "+ANSI_FONT_BOLD_ON + "%2$-20s" + ANSI_RESET + " | %3$-20s | %4$-20s | %5$-20s | %6$-20s |\n",
            DATA_OUT_0 = "| " + ANSI_YELLOW + "%1$-20s" + ANSI_RESET + " | " + ANSI_YELLOW + "%2$-20s" + ANSI_RESET + " | " + ANSI_YELLOW + "%3$-20s" + ANSI_RESET + " | " + ANSI_YELLOW + "%4$-20s" + ANSI_RESET + " | " + ANSI_YELLOW + "%5$-20s" + ANSI_RESET + " | " + ANSI_YELLOW + "%6$-20s" + ANSI_RESET + " |\n";
